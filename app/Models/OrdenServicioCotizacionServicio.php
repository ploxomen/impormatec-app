...
class OrdenServicioCotizacionServicio extends Model
{
    ...
    protected $fillable = ['id_orden_servicio','costo_total','id_firma_profesional','id_cotizacion_servicio','orden','fecha_termino','objetivos','acciones','descripcion','conclusiones_recomendaciones','estado','fecha_fin_garantia','responsable_usuario'];
    ...
    public static function obtenerInformesGenerados($fechaInicio,$fechaFin){
