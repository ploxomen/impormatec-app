...
class ServicioProducto extends Model
{
    ...
    public function scopeObtenerProductos($query,$idServicio){
        return $query->select("servicios_productos.id_servicio","servicios_productos.cantidadUsada","productos.nombreProducto","productos.id AS idProducto","productos.urlImagen")
