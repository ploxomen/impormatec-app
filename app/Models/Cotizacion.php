...
class Cotizacion extends Model
{
    ...
    protected $fillable = ['id_cliente','fecha_fin_garantia','id_pre_cotizacion','fechaCotizacion','fechaFinCotizacion','conversionMoneda','textoNota','tipoMoneda','referencia','representanteCliente','direccionCliente','importeTotal','descuentoTotal','igvTotal','total','mesesGarantia','incluirIGV','cotizadorUsuario','reportePreCotizacion','documento','reporteDetallado','estado'];
