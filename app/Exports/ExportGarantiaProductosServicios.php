...
class ExportGarantiaProductosServicios implements FromView,ShouldAutoSize,WithStyles
{
    private $datos;
    private $vista;
    private $fechaInicio;
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $rango = "A" . $this->filaInicial . ":H" . $this->filaFinal;
        $titulo = $sheet->getStyle('A2');
        ...
        $cabeceraTabla = $sheet->getStyle("A".$this->filaInicial . ':' . "H" . $this->filaInicial);
